...
import { classDiagramDocument } from "./fixtures/classDiagram";
import { flowchartDocument } from "./fixtures/flowchart";
import {
  brokenSequenceAlias,
  sequenceDiagramDocument,
} from "./fixtures/sequenceDiagram";
...
describe("vizlayer core", () => {
  ...
  describe("sequenceDiagram", () => {
    ...
    it("validates rendered Mermaid", () => {
      expect(
        validate(SequenceDiagram.fromJson(sequenceDiagramDocument)).ok
      ).toBe(true);
    });
  });
  ...
  describe("classDiagram", () => {
    ...
    it("validates rendered Mermaid", () => {
      expect(validate(ClassDiagram.fromJson(classDiagramDocument)).ok).toBe(
        true
      );
    });
  });
